...
urlpatterns = [
    ...
    path('leasing/<int:equipment_id>/', views.leasing_detail, name='leasing_detail'),
    ...
    path('contract/<int:pk>/download-docx/', views.contract_download_docx, name='contract_download_docx'),
