...
from apps.leasing.api.viewsets import (
    CompanyViewSet, CompanyContactViewSet, LeaseContractViewSet,
    PaymentScheduleViewSet, MaintenanceViewSet, MaintenanceRequestViewSet,
)
...
router.register(r'company-contacts', CompanyContactViewSet, basename='companycontact')
