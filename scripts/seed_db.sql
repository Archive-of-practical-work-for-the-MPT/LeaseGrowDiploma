...
('New Holland', 'Италия/США', 'https://www.newholland.com', 'Производитель тракторов и комбайнов'),
('AGCO (Massey Ferguson)', 'США', 'https://www.agcocorp.com', 'Производитель сельхозтехники'),
('Rostselmash', 'Россия', 'https://www.rostselmash.ru', 'Российский производитель комбайнов'),
